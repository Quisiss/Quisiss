...
import model.Answer;
import model.Users;
import model.controller.answerController;
...
public class FinishQuizServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(answers == null){
            request.setAttribute("message", "Enter your answer");
        ...
        for (int i = 0; i < answers.length; i++) {
            ...
            Answer a = new Answer(answers[i],u.getUserId() ,Integer.valueOf(questionId) );
            ac.createAnswer(a);
